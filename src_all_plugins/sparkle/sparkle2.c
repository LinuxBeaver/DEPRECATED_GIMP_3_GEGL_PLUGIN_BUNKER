...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *output, *color, *normal, *fix, *id1, *dt, *divide, *idref, *sparklestring, *replace, *opacity, *colorchange, *cellnoise;
...
gegl_node_link_many (input, id1, replace, sparklestring, colorchange, fix,  output,  NULL);
