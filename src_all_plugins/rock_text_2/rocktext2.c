...
#define TUTORIAL2 \
" mean-curvature-blur iterations=1  id=slemboss gimp:layer-mode opacity=0.50 layer-mode=softlight aux=[ ref=slemboss emboss depth=10 elevation=60 azimuth=120 ] noise-reduction iterations=2 "\
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *median, *spread, *ta, *es, *cb, *nop, *graph1, *levels, *multiply, *behind, *lspd,  *color,  *graph2, *output;
  ...
  gegl_node_link_many (input, median, spread, ta, cb, graph1, nop, behind, graph2, levels, multiply, es, output, NULL);
