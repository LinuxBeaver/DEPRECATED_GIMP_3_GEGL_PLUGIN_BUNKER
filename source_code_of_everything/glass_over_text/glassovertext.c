...
id=1
gimp:layer-mode layer-mode=erase composite-mode=auto aux=[ ref=1 dst-over aux=[ color value=#000000  ]  color-to-alpha opacity-threshold=0.14 color-overlay value=#000000 ]  ]
color-overlay value=#ffffff
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *output, *emboss, *color,  *white, *retract, *gaussian, *hyperopacity, *string;
  ...
  gegl_node_link_many (input, white, retract, emboss, string, color, hyperopacity, gaussian, output, NULL);
