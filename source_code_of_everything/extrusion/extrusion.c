...
id=1 dst-over aux=[ ref=1 motion-blur-zoom factor=0.06 center-x=-0.24 center-y=0.14 id=2 multiply aux=[ ref=2 sg:bevel    ]
 ...
 */
  ...
  gegl_operation_meta_redirect (operation, "depth", bevel, "depth");
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "reference-hash", "156j6bfzaa5014f2ks3b272ac",
