...
Requires plugins sg:innerglow, sg:embosstexture, sg:threshold-alpha, sg:edge-extract to work proper.
...
" id=ig alien-map cpn-1-frequency=5 cpn-2-frequency=3 cpn-2-frequency=13 gimp:desaturate mode=average hue-chroma lightness=-13 opacity value=6.0 id=color gimp:layer-mode layer-mode=hsl-color composite-mode=auto opacity=0.021  composite-mode=auto  aux=[ ref=color color-overlay value=#ffec2b box-blur radius=30 ] noise-reduction iterations=3 gimp:layer-mode layer-mode=grain-merge opacity=0.54 composite-mode=auto aux=[ ref=ig id=gimply gaussian-blur std-dev-x=14 std-dev-y=14 abyss-policy=none clip-extent=false translate x=0 y=0 src-out aux=[ ref=gimply  ]  opacity value=2 color-overlay value=#ffeb2b median-blur radius=0 gaussian-blur abyss-policy=none std-dev-x=5 std-dev-y=5  clip-extent=false ] levels in-low=0.032 id=shadow gimp:layer-mode layer-mode=behind opacity=0.033 aux=[ ref=shadow color-overlay value=#000000 gaussian-blur abyss-policy=none  clip-extent=false std-dev-x=12 std-dev-y=12  translate x=6 y=15  ] saturation scale=1.00 sg:threshold-alpha alphadegree=0.7 median-blur abyss-policy=none radius=0 id=ee gimp:layer-mode layer-mode=subtract opacity=0.07 aux=[ ref=ee sg:edge-extract ] id=et gimp:layer-mode layer-mode=subtract opacity=0.015 aux=[ ref=et  sg:embosstexture ] median-blur radius=0 abyss-policy=none id=sg gimp:layer-mode layer-mode=normal opacity=0.25 aux=[ ref=sg softglow brightness=0.45 ] bloom strength=20 id=dog gimp:layer-mode  layer-mode=grain-merge opacity=0.19 aux=[ ref=dog difference-of-gaussians ] "\
...
property_double (expand, _("Expand Bevel"), 5.0)
...
update_graph (GeglOperation *operation)
{
  ...
  GeglNode *usethis  = NULL;  /* the default blend mode */
  switch (o->blendmode) {
