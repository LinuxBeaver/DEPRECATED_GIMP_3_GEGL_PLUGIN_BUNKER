...
property_double  (alpha_percentile, _("Median's Alpha Percentile"), 63.0)
  value_range (51, 76)
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *cb, *in, *cubism, *cubism2, *oilify, *nop, *col, *color, *snn, *opacity, *median, *output;
  ...
  cb    = gegl_node_new_child (gegl,
                                  "operation", "sg:custom-bevel", "blendmode", 8,
                                  NULL);
  ...
  gegl_node_link_many (input, cubism, color, cubism2, oilify, snn, col, cb, NULL);
