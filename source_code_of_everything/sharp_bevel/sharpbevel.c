...
This requires another plugin of mine sg:threshold-alpha that is included.
...
sg:edgesmooth alpha-percentile2=100 gaus=0.8
sg:threshold-alpha
...
property_int (smooth, _("Smooth Bevel"), 9)
...
update_graph (GeglOperation *operation)
{
  ...
  GeglNode *usethis  = NULL;  /* the default */
  switch (o->blendmode) {
...
GeglProperties *o = GEGL_PROPERTIES (operation);
  GeglNode *input, *output, *fix, *fix2, *fix3, *smooth, *allowblack, *edgesmooth, *multiply3, *multiply4, *multiply5, *sharpen, *levels, *idref, *graph, *ta2, *ta2again, *opacity, *multiply, *dt, *c2a, *multiply2,  *imagefileoverlay, *median, *hardlight, *emboss,  *embossblend, *addition, *colordodge, *grainmerge, *softlight, *overlay, *darken, *lighten, *nop, *plus;
...
/* This is a dependency I made to remove edge puff or semi transparent artifact around edges. In this case it is removing artfifact around the bevel.  */
  ...
  edgesmooth    = gegl_node_new_child (gegl,
                                  "operation", "sg:edgesmooth", "gaus", 0.7,
                                  NULL);
...
GeglOperationMetaClass *operation_meta_class = GEGL_OPERATION_META_CLASS (klass);
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "gimp:menu-label", _("Sharp Bevel .19 friendly..."),
    NULL);
}
