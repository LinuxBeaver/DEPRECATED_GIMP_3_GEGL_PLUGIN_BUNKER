...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *graph1, *kali,  *id1, *color, *dt, *color2, *graph2, *behind, *output;
...
with the behind blend mode.*/
  gegl_node_link_many (input, graph1, kali, color, id1, behind, graph2, output, NULL);
  gegl_node_link_many (id1, dt, color2, NULL);
