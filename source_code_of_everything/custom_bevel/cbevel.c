...
property_double  (percentile, _("Internal Median Blur Percentile"), 53.0)
  value_range (20, 80)
...
property_double (gaus, _("Internal Gaussian Blur for a normal bevel"), 2.0)
...
property_double (lightness, _("Lightness "), 0.0)
   description  (_("Lightness adjustmennt"))
   value_range  (-12, 26.0)
ui_meta ("visible", "guichange {advancecustombevel}")
...
GeglProperties *o = GEGL_PROPERTIES (operation);
  GeglNode *input, *output, *median, *multiply, *hardlight, *white, *killpuff2,  *embossblend, *addition, *colordodge, *grainmerge, *softlight, *overlay, *darken, *darkbevel, *desat, *multiply2, *lighten, *mcol, *col, *plus, *opacity, *gaussian, *emboss, *box, *lightness, *imagefileoverlay, *mcb, *sharpen, *bookmark, *medianbookmark, *multiplybookmark, *repairgeglgraph;
...
GeglOperationMetaClass *operation_meta_class = GEGL_OPERATION_META_CLASS (klass);
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",        "sg:custom-bevel",
    "title",       _("Custom Bevel "),
    "reference-hash", "h3do6akv00vyeefjf25sb2ac2",
