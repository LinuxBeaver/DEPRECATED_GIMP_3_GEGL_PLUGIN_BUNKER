...
sg:glossy-balloon gaus=1  median-blur radius=0 gaussian-blur std-dev-x=1.5 std-dev-y=1.5
metallic
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *mediansize, *gbf, *metallic, *idref, *othergraph, *opacity, *c2a, *replaceblendmode, *output;
...
" sg:glossy-balloon gaus=1  median-blur  abyss-policy=none radius=0 gaussian-blur  abyss-policy=none  clip-extent=false std-dev-x=1.5 std-dev-y=1.5 "\
  ...
  metallic = gegl_node_new_child (gegl,
                                  "operation", "sg:metallic", "liquid", 1.0, "light", 5.0, "smooth", 2,
                                  NULL);
...
" opacity value=4 median-blur abyss-policy=none radius=0 "\
  ...
  gegl_node_link_many (idref, c2a, opacity, NULL);
 ...
 gegl_operation_meta_redirect (operation, "hardlightmode", opacity, "value");
