...
property_int (depth, _("Plastic depth"), 66)
   description (_("Emboss depth control of plastic"))
   value_range (60, 100)
   ui_range    (60, 100)
   ui_gamma    (3.0)

property_int (depth2, _("Faint plastic depth"), 20)
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *idref, *over, *normal, *mcb, *sl, *nr, *opacity, *blur, *gaussian, *alphalockreplaceblendmode, *alphalockreplaceblendmode2, *idref2, *idref3,  *emboss, *emboss2, *output;
...
/*If you are interested in developing GEGL plugins pay attention to how the same gegl:nop node (idref) is used 3 times to match the gegl syntax on the top of the page. nop is both the id and ref */
  ...
  gegl_node_link_many (idref, idref3, alphalockreplaceblendmode2, emboss, emboss2, opacity,  NULL);
