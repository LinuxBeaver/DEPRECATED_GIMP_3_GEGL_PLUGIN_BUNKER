...
id=bll
gimp:layer-mode layer-mode=linear-light composite-mode=auto blend-space=rgb-perceptual opacity=0.05  aux=[ ref=bll sg:bevel ]
...
property_int (depth, _("Depth and or detail of bevel"), 24)
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *alienmap, *white, *bloom, *boxblur, *bevel, *cb, *col, *color,  *graph1, *graph2, *graph3,  *desat, *replace2, *edge, *hslcolor, *idref, *idref2, *idref3, *idref4, *linearlight, *median, *nr, *replace, *fixgraph,  *saturation, *ta2, *output;
  ...
  cb    = gegl_node_new_child (gegl,
                                  "operation", "sg:custom-bevel", "blendmode", 3, "opacity", 4.9, 
                                  NULL);
  ...
  col    = gegl_node_new_child (gegl,
                                  "operation", "gegl:color-overlay", "value", embedded_color,
                                  NULL);
...
replace = gegl_node_new_child (gegl,
                                    "operation", "gimp:layer-mode", "layer-mode", 62, "composite-mode", 0, "opacity", 1.0,  "blend-space", 0, NULL);

replace2 = gegl_node_new_child (gegl,
                                    "operation", "gimp:layer-mode", "layer-mode", 62, "composite-mode", 0,  "opacity", 0.15,  "blend-space", 0, NULL);
...
drop shadow is applied in a gegl graph below them.*/
  ...
  gegl_operation_meta_redirect (operation, "topbevelexpand", bevel, "gaus");
  gegl_operation_meta_redirect (operation, "topbevelelevation", bevel, "elevation");
  gegl_operation_meta_redirect (operation, "topbeveldepth", bevel, "depth");



  gegl_node_link_many (input, white, median, col, cb, idref, replace, graph1, idref2, hslcolor, nr, bloom, saturation, idref3, linearlight, idref4, replace2, graph2, graph3, fixgraph, ta2, output, NULL);
